  ...
  <f7-app :params="f7params" >
    ...
    <f7-views tabs class="safe-areas">
      ...
      <f7-toolbar tabbar labels bottom>
        ...
        <f7-link @click="onTabLinkClick('games')" tab-link="#view-games" icon-f7="rocket_fill" text="Games"></f7-link>
        <f7-link @click="onTabLinkClick('apps')" tab-link="#view-apps" icon-f7="layers_alt_fill" text="Apps"></f7-link>
        <f7-link @click="onTabLinkClick('arcade')" tab-link="#view-arcade" icon-f7="gamecontroller_alt_fill" text="Arcade"></f7-link>
      ...
      <f7-view id="view-arcade" @tab:show="setActiveTab('arcade')" tab url="/arcade/"></f7-view>
